...
!!! warning "Legacy Mesh"
    Documentation on this page relies on our [legacy mesh](legacy-mesh.md) data
    structure.  For the current `SurfaceMesh`-based cleanup utilities, see the
    [Mesh Cleanup](mesh-cleanup.md) page.
